...
const projects = [
  {
    ...
    description: "In this project I designed an elementary Central Processing Unit from a Read-Only Memory. I handled a 3-bit instruction field by means of RALU with state machine controller, Instruction Register, Program Counter, (and memory module to fetch instructions automatically) . UF Course: EEL4744",
    links: {
  ...
  return (
    <div>
      <h2 className='text-4xl font-bold text-gray-200 mb-8 text-center'>Portfolio</h2>
      <div className='max-w-[1600px] mx-auto px-12 md:my-20' id="portfolio">
